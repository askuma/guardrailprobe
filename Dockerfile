...
LABEL maintainer="Ashutosh Kumar <ashuthemaddy@gmail.com>"
...
# System build deps required for cryptography (pyhanko), httpx, and spaCy
...
RUN pip install --no-cache-dir --upgrade pip && \
    ...
    pip install --no-cache-dir -e ".[guardrails_ai,presidio]"
...
# Output directories
RUN mkdir -p /app/reports /app/docs/benchmarks /app/certs
...
CMD ["guardrailprobe", "dashboard", "--port", "8080"]
